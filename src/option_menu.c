...
} static const sItemFunctionsMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BATTLEITEMS]  = {DrawChoices_BattleItems, ProcessInput_Options_Two},
...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BATTLEITEMS] = gText_BattleItemsM,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_MAIN:
        ...
        case MENUITEM_MAIN_BATTLEITEMS:     return TRUE;
...
static const u8 sText_Desc_BattleStyle_Set[]        = _("No free switch after a KO.\nTrainers give more money.");
static const u8 sText_Desc_BattleItems_Enabled[]    = _("Allows the use of items in battle.");
static const u8 sText_Desc_BattleItems_Disabled[]   = _("Disables the bag in trainer battles.\nTrainers give more money.");
...
static const u8 *const sOptionMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    ...
    [MENUITEM_MAIN_BATTLEITEMS] = {sText_Desc_BattleItems_Enabled,  sText_Desc_BattleItems_Disabled,    sText_Empty},
...
static const u8 *const sOptionMenuItemDescriptionsDisabledMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BATTLEITEMS] = sText_Empty,
...
void CB2_InitOptionMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel[MENUITEM_MAIN_BATTLEITEMS] = gSaveBlock2Ptr->optionsFlagItemUse;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsFlagItemUse      = sOptions->sel[MENUITEM_MAIN_BATTLEITEMS];
...
static void DrawChoices_BattleItems(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_BATTLEITEMS);
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(gText_BattleItemsEnabled, 104, y, styles[0], active);
    DrawOptionMenuChoice(gText_BattleItemsDisabled, GetStringRightAlignXOffset(FONT_NORMAL, gText_BattleItemsDisabled, 198), y, styles[1], active);
}
