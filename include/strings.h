...
extern const u8 gText_BattleItemsEnabled[];
extern const u8 gText_BattleItemsDisabled[];
...
extern const u8 gText_BattleItemsM[];
...
extern const u8 gText_ShopPurchased[];
